...
#define ENUM_CASE(name, value) \
    ...
    switch (layout) { ButtonLayout_VALUELIST(ENUM_CASE) default : return "BUTTON_LAYOUT_UNKNOWN"; }
#undef ENUM_CASE
}
...
#define ENUM_CASE(name, value) \
    case name: return #name;
    switch (layout) { ButtonLayoutRight_VALUELIST(ENUM_CASE) default : return "BUTTON_LAYOUT_UNKNOWN"; }
#undef ENUM_CASE
}
...
LayoutManager::LayoutList LayoutManager::getLeftLayout(uint16_t index) {
    ...
    switch (index) {
        ...
        case BUTTON_LAYOUT_STICK           : return drawArcadeStick();
        case BUTTON_LAYOUT_TWINSTICKA      : return drawTwinStickA();
        case BUTTON_LAYOUT_VLXA            : return drawVLXA();
        case BUTTON_LAYOUT_FIGHTBOARD_STICK: return drawFightboardStick();
        // buttons
        // parameters: x, y, radiusX/width, radiusY/height, stroke, fill, Gamepad button mask, shape
        case BUTTON_LAYOUT_STICKLESS            : return drawStickless();
        case BUTTON_LAYOUT_BUTTONS_ANGLED       : return drawUDLR();
        case BUTTON_LAYOUT_BUTTONS_BASIC        : return drawMAMEA();
        case BUTTON_LAYOUT_KEYBOARD_ANGLED      : return drawKeyboardAngled();
        case BUTTON_LAYOUT_KEYBOARDA            : return drawWasdBox();
        case BUTTON_LAYOUT_DANCEPADA            : return drawDancepadA();
        case BUTTON_LAYOUT_BLANKA               : return drawBlankA();
        case BUTTON_LAYOUT_FIGHTBOARD_MIRRORED  : return drawFightboardMirrored();
        ...
        case BUTTON_LAYOUT_POPN_A               : return drawPopnA();
        case BUTTON_LAYOUT_TAIKO_A              : return drawTaikoA();
        case BUTTON_LAYOUT_BM_TURNTABLE_A       : return drawBMTurntableA();
        case BUTTON_LAYOUT_BM_5KEY_A            : return drawBM5KeyA();
        case BUTTON_LAYOUT_BM_7KEY_A            : return drawBM7KeyA();
        case BUTTON_LAYOUT_GITADORA_FRET_A      : return drawGitadoraFretA();
        case BUTTON_LAYOUT_GITADORA_STRUM_A     : return drawGitadoraStrumA();
        case BUTTON_LAYOUT_BOARD_DEFINED_A      : return drawBoardDefinedA();
        case BUTTON_LAYOUT_BANDHERO_FRET_A      : return drawBandHeroFretA();
        case BUTTON_LAYOUT_BANDHERO_STRUM_A     : return drawBandHeroStrumA();
        case BUTTON_LAYOUT_6GAWD_A              : return draw6GAWDLeft();
        case BUTTON_LAYOUT_6GAWD_ALLBUTTON_A    : return draw6GAWDAllButtonLeft();
        case BUTTON_LAYOUT_6GAWD_ALLBUTTONPLUS_A: return draw6GAWDAllButtonPlusLeft();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT0_A : return drawBoardDefinedAlt0A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT1_A : return drawBoardDefinedAlt1A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT2_A : return drawBoardDefinedAlt2A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT3_A : return drawBoardDefinedAlt3A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT4_A : return drawBoardDefinedAlt4A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT5_A : return drawBoardDefinedAlt5A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT6_A : return drawBoardDefinedAlt6A();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT7_A : return drawBoardDefinedAlt7A();
        default                                 : break;
    }
...
LayoutManager::LayoutList LayoutManager::getRightLayout(uint16_t index) {
    ...
    // parameters: x, y, radiusX/width, radiusY/height, stroke, fill, Gamepad button mask, shape
    switch (index) {
        case BUTTON_LAYOUT_ARCADE                   : return this->drawArcadeButtons();
        case BUTTON_LAYOUT_STICKLESSB               : return this->drawSticklessButtons();
        case BUTTON_LAYOUT_BUTTONS_ANGLEDB          : return this->drawWasdButtons();
        case BUTTON_LAYOUT_VEWLIX                   : return this->drawVewlix();
        case BUTTON_LAYOUT_VEWLIX7                  : return this->drawVewlix7();
        case BUTTON_LAYOUT_CAPCOM                   : return this->drawCapcom();
        case BUTTON_LAYOUT_CAPCOM6                  : return this->drawCapcom6();
        case BUTTON_LAYOUT_SEGA2P                   : return this->drawSega2p();
        case BUTTON_LAYOUT_SEGA2P_6B                : return this->drawSega2p6b();
        case BUTTON_LAYOUT_NOIR8                    : return this->drawNoir8();
        case BUTTON_LAYOUT_KEYBOARDB                : return this->drawMAMEB();
        case BUTTON_LAYOUT_TWINSTICKB               : return this->drawTwinStickB();
        case BUTTON_LAYOUT_BLANKB                   : return this->drawBlankB();
        case BUTTON_LAYOUT_VLXB                     : return this->drawVLXB();
        case BUTTON_LAYOUT_VLXB_6B                  : return this->drawVLXB6B();
        case BUTTON_LAYOUT_FIGHTBOARD               : return this->drawFightboard();
        case BUTTON_LAYOUT_FIGHTBOARD_STICK_MIRRORED: return this->drawFightboardStickMirrored();
        case BUTTON_LAYOUT_CUSTOMB                  : return this->drawButtonLayoutRight();
        ...
        case BUTTON_LAYOUT_POPN_B                   : return this->drawPopnB();
        case BUTTON_LAYOUT_TAIKO_B                  : return this->drawTaikoB();
        case BUTTON_LAYOUT_BM_TURNTABLE_B           : return this->drawBMTurntableB();
        case BUTTON_LAYOUT_BM_5KEY_B                : return this->drawBM5KeyB();
        case BUTTON_LAYOUT_BM_7KEY_B                : return this->drawBM7KeyB();
        case BUTTON_LAYOUT_GITADORA_FRET_B          : return this->drawGitadoraFretB();
        case BUTTON_LAYOUT_GITADORA_STRUM_B         : return this->drawGitadoraStrumB();
        case BUTTON_LAYOUT_BOARD_DEFINED_B          : return this->drawBoardDefinedB();
        case BUTTON_LAYOUT_BANDHERO_FRET_B          : return drawBandHeroFretB();
        case BUTTON_LAYOUT_BANDHERO_STRUM_B         : return drawBandHeroStrumB();
        case BUTTON_LAYOUT_6GAWD_B                  : return draw6GAWDRight();
        case BUTTON_LAYOUT_6GAWD_ALLBUTTON_B        : return draw6GAWDAllButtonRight();
        case BUTTON_LAYOUT_6GAWD_ALLBUTTONPLUS_B    : return draw6GAWDAllButtonPlusRight();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT0_B     : return this->drawBoardDefinedAlt0B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT1_B     : return this->drawBoardDefinedAlt1B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT2_B     : return this->drawBoardDefinedAlt2B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT3_B     : return this->drawBoardDefinedAlt3B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT4_B     : return this->drawBoardDefinedAlt4B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT5_B     : return this->drawBoardDefinedAlt5B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT6_B     : return this->drawBoardDefinedAlt6B();
        case BUTTON_LAYOUT_BOARD_DEFINED_ALT7_B     : return this->drawBoardDefinedAlt7B();
        default                                     : break;
    }
...
LayoutManager::LayoutList LayoutManager::adjustByCustomSettings(LayoutManager::LayoutList layout,
                                                                ButtonLayoutParamsCommon common, uint16_t originX,
                                                                uint16_t originY) {
    if (layout.size() > 0) {
        ...
        for (uint16_t elementCtr = 0; elementCtr < layout.size(); elementCtr++) {
            ...
            if (((GPShape_Type)layout[elementCtr].parameters.shape == GP_SHAPE_ELLIPSE) ||
                ((GPShape_Type)layout[elementCtr].parameters.shape == GP_SHAPE_POLYGON)) {
                // radius
...
LayoutManager::LayoutList LayoutManager::adjustByOffset(LayoutManager::LayoutList layout, int16_t originX,
                                                        int16_t originY) {
    if (layout.size() > 0) {
        ...
        for (uint16_t elementCtr = 0; elementCtr < layout.size(); elementCtr++) {
            ...
            if (((GPShape_Type)layout[elementCtr].parameters.shape == GP_SHAPE_ELLIPSE) ||
                ...
                if (originX > 0) {
                    newX = layout[elementCtr].parameters.x2 + originX;
                }
            }
...
LayoutManager::LayoutList LayoutManager::flipHorizontally(LayoutList layout, int16_t startX, int16_t startY,
